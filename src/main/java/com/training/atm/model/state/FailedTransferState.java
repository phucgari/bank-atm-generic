...
/** Terminal state reached when the scheduler could not execute the transfer. */
public class FailedTransferState implements TransferLifecycleState {
    ...
    @Override public TransferStatus         toStatus()                      { return TransferStatus.FAILED; }
}
